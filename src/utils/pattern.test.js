...
describe('unit: pattern', () => {
  ...
  it('match', async () => {
    ...
    expect(pattern.match('/**', '/hello')).to.equal(true)
    expect(pattern.match('/*', '/hello/hi')).to.equal(false)
    expect(pattern.match('/**', '/hello/hi')).to.equal(true)
    expect(pattern.match('/**', '/hello/hi/')).to.equal(true)
    expect(pattern.match('/**', '/really/long/path/yo')).to.equal(true)
    expect(pattern.match('/hello', '/hello')).to.equal(true)
    expect(pattern.match('/hello*', '/helloo')).to.equal(true)
    expect(pattern.match('/hello*', '/hello/')).to.equal(false)
    expect(pattern.match('/hello**', '/hello/')).to.equal(true)
    expect(pattern.match('/hello*', '/hello/hi')).to.equal(false)
    expect(pattern.match('/hello**', '/hello/hi')).to.equal(true)
    expect(pattern.match('/{name}', '/')).to.equal(false)
    expect(pattern.match('/{name}', '/jane')).to.equal(true)
    expect(pattern.match('/hello/{name}', '/hello/jane')).to.equal(true)
    expect(pattern.match('/hello/{name}', '/hello/')).to.equal(false)
    expect(pattern.match('/hello-{name}', '/hello-jane')).to.equal(true)
    expect(pattern.match('/he*o-{name}', '/heyo-jane')).to.equal(true)
    expect(pattern.match('/he*o-{name}', '/hello-jane')).to.equal(true)
    expect(pattern.match('/he*o-{name}', '/heo-jane')).to.equal(true)
    expect(pattern.match('/he*o-{name}', '/he-jane')).to.equal(false)
    expect(pattern.match('/hello-{first-name}', '/hello-jane')).to.equal(false)
    expect(pattern.match('/hello-{first_name}', '/hello-jane')).to.equal(true)
    expect(pattern.match('/hello-{first$name}', '/hello-jane')).to.equal(false)
    expect(pattern.match('/hello-{first(name)}', '/hello-jane')).to.equal(false)
